 # DECODED BY MR-DEVIL #Gift By ASRAFUL ISLAM 𝐌𝐄-𝐍𝐀𝐇𝐈𝐃
#Group: MR DEVIL TERMUX ZONE
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/S4B7Z/shadow/blob/main/shadow.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
        ...
        os.system('am start https://wa.me/+8801624069516?text=' + tks)
        superuser()        
superuser()
